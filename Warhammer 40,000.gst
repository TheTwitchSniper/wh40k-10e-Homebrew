...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="sys-352e-adc2-7639-d6a9" name="Warhammer 40k 10e - Auxiliaries" revision="22" battleScribeVersion="2.03" type="gameSystem">
  <publications>
    <publication id="48fc-15aa-b307-9443" name="10e - Aux Rules" shortName="10e - Aux Rules"/>
    <publication name="Github" hidden="false" id="8db3-575d-91b-47f8" shortName="Twitch/wh40k-10e/Aux" publisherUrl="https://github.com/TheTwitchSniper/wh40k-10e-Homebrew"/>
  </publications>
  <costTypes>
...
If a model is in Hover mode,  then until the end of the battle, its Move characteristic is changed to 20&quot;, it loses the AIRCRAFT keyword and it loses all associated rules for being an AlRCRAFT model. Models in Hover mode do not start the battle in Reserves, but you can choose to place them into Strategic Reserves following the normal rules if you wish.</description>
    ...
    <rule name="Rearing Strike" id="efff-1faf-f901-8d67" hidden="false">
      <description>Weapons with [REARING STRIKE] in their profile are known as Rearing Strike weapons. Each time the bearer fights, if there is more than one enemy unit within Engagement Range of the bearer, the bearer can make attacks with this weapon.</description>
    </rule>
  </sharedRules>
  <sharedProfiles>
